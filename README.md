...
**Tracking a romantic turn-based RPG in pre-alpha.**
...
Dreamy Love Voyage is a single-player RPG adventure set in a seaside city, combining turn-based combat, romance, and visual-novel presentation. This repository records pre-alpha development work, iteration, and documentation for the Windows version, currently listed for Q3 2027.

This devlog is for players and developers interested in small-scale RPGs, romance-focused adventures, and iterative game development.
...
- ⚔️ **Turn-Based Combat** — Combat uses turn-based encounters and tactical decisions.
- 🌊 **Seaside Setting** — The story takes place around a coastal city.
- 💬 **Romance Story** — Romantic interactions are integrated into the adventure.
- 📖 **Visual-Novel Elements** — Story scenes use visual-novel style presentation.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1733440/ss_ef21e8ccfa3577f31f3932fc2537ef1f84ce1fc5.1920x1080.jpg?t=1720300367" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1733440/ss_09c72b139c6b43c6812101cf499298cb19ddef4a.1920x1080.jpg?t=1720300367" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1733440/ss_e2be863bfb7eff94e41b016c1ab46ba4046d556f.1920x1080.jpg?t=1720300367" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 11-compatible graphics card | DirectX 11-compatible graphics card with 2 GB VRAM |
| **Storage** | 2 GB available space | 2 GB available space (SSD preferred) |
| **Additional** | DirectX 11 | DirectX 11 and current graphics drivers |
